...
print(db_admin)
print(type(db_admin))
print(db_admin.collection_names())
print(db_admin.profiling_info())
...
print(type(cln_poloniex_btc_usdt))
print(cln_poloniex_btc_usdt.index_information())
