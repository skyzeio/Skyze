...
#         p_data["Av_Tr_Rge"] = atr.calculate(p_data)
        ...
        for i, row in p_data.iterrows(): 
            ...
            if i < self.st_period:
                p_data.set_value(i, 'basic_ub'+self.name_extension, 0.00)
                p_data.set_value(i, 'basic_lb'+self.name_extension, 0.00)
                p_data.set_value(i, 'final_ub'+self.name_extension, 0.00)
                p_data.set_value(i, 'final_lb'+self.name_extension, 0.00)
                p_data.set_value(i, 'Super_Trend'+self.name_extension, 0.00)
            else:
                p_data.set_value(i, 'final_ub'+self.name_extension, (p_data.get_value(i, 'basic_ub'+self.name_extension) 
                                             if p_data.get_value(i, 'basic_ub'+self.name_extension) < p_data.get_value(i-1, 'final_ub'+self.name_extension) or 
                ...
                p_data.set_value(i, 'final_lb'+self.name_extension, (p_data.get_value(i, 'basic_lb'+self.name_extension) 
                                             if p_data.get_value(i, 'basic_lb'+self.name_extension) > p_data.get_value(i-1, 'final_lb'+self.name_extension) or 
                ...
                p_data.set_value(i, 'Super_Trend'+self.name_extension, (p_data.get_value(i, 'final_ub'+self.name_extension)
                                                         if ( ( p_data.get_value(i-1, 'Super_Trend'+self.name_extension) == p_data.get_value(i-1, 'final_ub'+self.name_extension) ) and 
                                                              ( p_data.get_value(i, 'Close')         <= p_data.get_value(i, 'final_ub'+self.name_extension)   )       )
                                                         else ( p_data.get_value(i, 'final_lb'+self.name_extension)
                                                                   if ( (p_data.get_value(i-1, 'Super_Trend'+self.name_extension) == p_data.get_value(i-1, 'final_ub'+self.name_extension) ) and 
                                                                        (p_data.get_value(i, 'Close')          > p_data.get_value(i, 'final_ub'+self.name_extension)   )       )
                                                                   else ( p_data.get_value(i, 'final_lb'+self.name_extension)
                                                                             if ( (p_data.get_value(i-1, 'Super_Trend'+self.name_extension) == p_data.get_value(i-1, 'final_lb'+self.name_extension) ) and 
                                                                                  (p_data.get_value(i, 'Close')        >= p_data.get_value(i, 'final_lb'+self.name_extension)    )      )
                                                                             else (p_data.get_value(i, 'final_ub'+self.name_extension)
                                                                                       if ( (p_data.get_value(i-1, 'Super_Trend'+self.name_extension) == p_data.get_value(i-1, 'final_lb'+self.name_extension) ) and 
                                                                                            (p_data.get_value(i, 'Close')          < p_data.get_value(i, 'final_lb'+self.name_extension)   )      )
                                                                                       else 0.00
                                                                                  )
